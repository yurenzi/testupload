...
public class suraidodoayoko : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            // 線形補間を使って徐々にスライドさせる
            pos.y = Mathf.Lerp(pos.y, startPos.y + distance, Time.deltaTime * 5f);
        }
        else
        {
            // 元の位置に戻る
            pos.y = Mathf.Lerp(pos.y, startPos.y, Time.deltaTime * 5f);
        }
